...
CLI tool for searching the [Enamine REAL Space](https://enamine.net/compound-collections/real-compounds) chemical database for structurally similar molecules using ECFP4 Tanimoto similarity.
